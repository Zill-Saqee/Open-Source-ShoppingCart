...
export default function Header() {
    ...
    return (
        <Navbar bg="dark" variant="dark"  sticky="top">
            <Navbar.Brand  onClick={() => navigate("/")}>Ecommerce Website</Navbar.Brand>

            <Button variant="info" className="ml-auto" onClick={() => navigate("/CartPage")}>
                ...
                <Badge variant="light">{cartCount}</Badge>
